...
static sc_boolean TECX_DEBOUNCE_react(Application* handle, const sc_boolean try_transition);
static sc_boolean TECX_NO_OPRIMIDO_react(Application* handle, const sc_boolean try_transition);
static sc_boolean TECX_OPRIMIDO_react(Application* handle, const sc_boolean try_transition);
static sc_boolean TECX_VALIDACION_react(Application* handle, const sc_boolean try_transition);
static sc_boolean main_region_ESPERA_react(Application* handle, const sc_boolean try_transition);
static sc_boolean LED3_TITILA_react(Application* handle, const sc_boolean try_transition);
static sc_boolean LED3_TITILA_r1_ENCENDIDO_react(Application* handle, const sc_boolean try_transition);
static sc_boolean LED3_TITILA_r1_APAGADO_react(Application* handle, const sc_boolean try_transition);
static sc_boolean LED3_REPOSO_react(Application* handle, const sc_boolean try_transition);
...
static sc_boolean TECX_DEBOUNCE_react(Application* handle, const sc_boolean try_transition) {
	...
	{ 
		...
		{ 
			if (handle->timeEvents.application_TECX_DEBOUNCE_tev0_raised == bool_true)
			{ 
				exseq_TECX_DEBOUNCE(handle);
...
static sc_boolean main_region_ESPERA_react(Application* handle, const sc_boolean try_transition) {
	...
	if (try_transition == bool_true)
	{ 
		if (((handle->internal.siTECXOK_raised) == bool_true) && (((handle->internal.viTecla) == (APPLICATION_APPLICATIONIFACE_TEC4)) == bool_true))
		{ 
			exseq_main_region_ESPERA(handle);
		...
		{
			if (((handle->internal.siTECXOK_raised) == bool_true) && (((handle->internal.viTecla) == (APPLICATION_APPLICATIONIFACE_TEC3)) == bool_true))
			{ 
				exseq_main_region_ESPERA(handle);
			...
			{
				if (((handle->internal.siTECXOK_raised) == bool_true) && (((handle->internal.viTecla) == (APPLICATION_APPLICATIONIFACE_TEC2)) == bool_true))
				{ 
					exseq_main_region_ESPERA(handle);
				...
				{
					if (((handle->internal.siTECXOK_raised) == bool_true) && (((handle->internal.viTecla) == (APPLICATION_APPLICATIONIFACE_TEC1)) == bool_true))
					{ 
						exseq_main_region_ESPERA(handle);
...
static sc_boolean LED3_TITILA_react(Application* handle, const sc_boolean try_transition) {
	...
	if (try_transition == bool_true)
	{ 
		if (handle->internal.siNoTitilarLED_raised == bool_true)
		{ 
...
static sc_boolean LED3_TITILA_r1_ENCENDIDO_react(Application* handle, const sc_boolean try_transition) {
	...
	{ 
		...
		{ 
			if (handle->timeEvents.application_LED3_TITILA_r1_ENCENDIDO_tev0_raised == bool_true)
			{ 
				exseq_LED3_TITILA_r1_ENCENDIDO(handle);
				enseq_LED3_TITILA_r1_APAGADO_default(handle);
			}  else
...
static sc_boolean LED3_TITILA_r1_APAGADO_react(Application* handle, const sc_boolean try_transition) {
	...
	{ 
		if ((LED3_TITILA_react(handle, try_transition)) == (bool_false))
		{ 
			if (handle->timeEvents.application_LED3_TITILA_r1_APAGADO_tev0_raised == bool_true)
			{ 
				exseq_LED3_TITILA_r1_APAGADO(handle);
...
static sc_boolean LED3_REPOSO_react(Application* handle, const sc_boolean try_transition) {
	...
	if (try_transition == bool_true)
	{ 
		if (handle->internal.siTitilarLED_raised == bool_true)
		{ 
			exseq_LED3_REPOSO(handle);
